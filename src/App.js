         ...
         <div className='bg-white w-full max-w-lg shadow-md mx-auto rounded-lg p-8'>
             ...
             <div className="flex shadow overflow-hidden rounded-lg mb-4">
                 <input 
                   ...
                   readOnly></input>
                 <button className="bg-blue-400 px-3 py-1 border-2 border-black border-s-0">Copy</button>
             </div>
             <div className="flex gap-x-2 text-sm">
                 ...
                 <div className="flex gap-x-1 items-center">
                 <input type="checkbox" id="number" onChange={checkNumberAllowed}></input>
                 <label htmlFor="number">Number</label>
                 </div>
                 <div className="flex gap-x-1 items-center">
                 <input type="checkbox" id="character" onChange={checkCharacterAllowed}></input>
